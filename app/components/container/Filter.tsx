...
const Filter = (props: Props) => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        console.log("response44", response.data);
      })
      .catch((error) => {
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col py-3 pb-5 tet-sm text-neutral-600 border-b-[0.5px]">
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Blouses") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Shirt") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Denim&Jeans") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Party") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Pants") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Skirts") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Tops&tees") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Jackets&Coats") ? "bg-purple-50" : ""
            }`}
